  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header alert-info">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user"></i> Create complainant</h5>
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn btn-info" name="create_complainant" id="policecreate"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
      </div>
      </form>
    </div>
  </div>
