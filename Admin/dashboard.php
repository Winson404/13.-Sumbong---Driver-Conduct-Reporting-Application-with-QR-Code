                      ...
                      <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-lg-3 col-6">
                          <div class="small-box bg-light">
                            <div class="inner">
                              <?php
                                $users = mysqli_query($conn, "SELECT police_Id from police");
                                $row_users = mysqli_num_rows($users);
                               ?>
                              <h3><?php echo $row_users; ?></h3>

                              <p>Total of Police Officers</p>
                            </div>
                            <div class="icon">
                              <i class="fa-solid fa-user-secret"></i>
                            </div>
                            <a href="police.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                          </div>
                        </div>
