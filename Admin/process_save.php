<?php 
	...
	if(isset($_POST['create_police'])) {
		...
		if(empty($file)) {
				...
				$check_email = mysqli_query($conn, "SELECT * FROM police WHERE email='$email'");
		      ...
		      $_SESSION['status'] = "error";
					header("Location: police.php");
						  		...
						  		$save = mysqli_query($conn, "INSERT INTO police (p_fname, p_mname, p_lname, p_suffix, gender, dob, age, address, email, contact, password,date_registered) VALUES ('$firstname', '$middlename', '$lastname', '$suffix', '$gender', '$dob', '$age', '$address', '$email', '$contact', '$password', '$date_registered')");

		              if($save) {
				          	$_SESSION['message'] = "Police information has been successfully saved!";
				...
				header("Location: police.php");
	                  ...
	                  // if everything is ok, try to upload file
	                      ...
	                      if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
	                      	...
	                      	$save = mysqli_query($conn, "INSERT INTO police (p_fname, p_mname, p_lname, p_suffix, gender, dob, age, address, email, contact, password, image, date_registered) VALUES ('$firstname', '$middlename', '$lastname', '$suffix', '$gender', '$dob', '$age', '$address', '$email', '$contact', '$password', '$file','$date_registered')");
	...
	// SAVE COMPLAINANT
	if(isset($_POST['create_complainant'])) {
				...
				header("Location: complainant.php");
	                  ...
	                  // if everything is ok, try to upload file
	                      ...
	                      if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
	                      	...
	                      	$save = mysqli_query($conn, "INSERT INTO complainants (c_fname, c_mname, c_lname, c_suffix, gender, dob, age, address, email, contact, password, image, date_registered) VALUES ('$firstname', '$middlename', '$lastname', '$suffix', '$gender', '$dob', '$age', '$address', '$email', '$contact', '$password', '$file','$date_registered')");
