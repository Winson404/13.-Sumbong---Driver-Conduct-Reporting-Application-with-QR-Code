                  ...
                  <tbody id="users_data">
                    <tr>
                      ...
                      ?>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#view<?php echo $row['complainant_Id']; ?>"><i class="fa-solid fa-eye"></i></button>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?php echo $row['complainant_Id']; ?>"><i class="fa-solid fa-trash-can"></i></button>
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#videocall<?php echo $row['complainant_Id']; ?>"><i class="fa-solid fa-video"></i></button>
                        </td> 
                    </tr>
