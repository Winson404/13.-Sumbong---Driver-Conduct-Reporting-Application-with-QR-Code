<?php
    ...
    if(isset($_SESSION['complainant_Id'])) {
    $id = $_SESSION['complainant_Id'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="wrapper">
 ...
 <!--  <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <?php 
          ...
          $count = mysqli_query($conn, "SELECT link_Id FROM video_links WHERE complainant_Id='$id'");
          $row_c = mysqli_num_rows($count);

          $fetch = mysqli_query($conn, "SELECT * FROM video_links JOIN police ON video_links.police_Id=police.police_Id WHERE complainant_Id='$id'");
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-danger navbar-badge"><?php echo $row_c; ?></span>
        </a>
            ...
            <div class="media">
              ...
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  <?php echo ' '.$link['p_fname'].' '.$link['p_mname'].' '.$link['p_lname'].' '.$link['p_suffix'].' '; ?>
                  <span class="float-right text-sm text-danger"><i class="fas fa-star"></i></span>
                </h3>
                <p class="text-sm">Waiting for your respone...</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> <?php echo $link['time_sent']; ?></p>
              </div>
            </div>
          </a>
          <div class="dropdown-divider"></div>
          <a href="video_call_links.php" class="dropdown-item dropdown-footer">See All Messages</a>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <?php 
        $admin = mysqli_query($conn, "SELECT * FROM complainants WHERE complainant_Id='$id'");
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../images-complainant/<?php echo $row['image']; ?>" alt="User Image" style="height: 34px; width: 34px; border-radius: 50%;">
        </div>
        <div class="info">
          <a href="about_me.php" class="d-block"><?php echo ' '.$row['c_fname'].' '.$row['c_mname'].' '.$row['c_lname'].' '.$row['c_suffix'].' '; ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="report.php" class="nav-link"><i class="fa-solid fa-user"></i><p>&nbsp;&nbsp; Complaints</p></a>
          </li>
