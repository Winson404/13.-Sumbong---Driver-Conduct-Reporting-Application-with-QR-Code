<title>Account security | Driver Conduct Reporting Application</title>
<?php 
  include 'navbar.php';
                    ...
                    <div class="row  d-flex justify-content-center">
                      <div class="col-lg-10 d-flex justify-content-center">
                        <div class="card-footer">
                          <button type="submit" class="btn btn-info" name="password_complainant" id="new_create"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                        </div>
                      </div>
                    </div>  
               </div>
