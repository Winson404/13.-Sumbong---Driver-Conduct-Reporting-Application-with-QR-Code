<title>Profile | Driver Conduct Reporting Application</title>
<?php 
  include 'navbar.php';
            ...
            <div class="card card-info">
              ...
              <form action="about_me_update_code.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info" name="update_complainant"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
